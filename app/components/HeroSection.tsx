...
export function HeroSection({ selectedTournament }: HeroSectionProps) {
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-b from-black via-red-900/30 to-black" />
              ...
              <div className="space-y-10">
                <div className="space-y-6">
                  <div className="inline-flex items-center gap-6 mb-8">
                    <div className="w-1 h-20 bg-linear-to-b from-red-600 to-red-500 rounded-full shadow-lg shadow-red-500/50" />
